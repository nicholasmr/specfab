...
\gdef\drawframe#1#2#3#4{
	...
	\begin{tikzpicture}[tdplot_main_coords, 
		...
		inner frame xsep=1ex, inner frame ysep=1ex] 
	...
	%%% ODF
	\begin{scope}[shift={(38em,1.3em)}]
		\node[] at (0,0) {\includegraphics[scale=1.35]{frames/ODF#1.png}};
	\end{scope}
...
\begin{document}
	...
	\pgfmathsetmacro{\dn}{5} % plot every \dn time step
