...
# Shading labels
plt.text(0.26/norm, 0.1/norm, '{\\bf Single maximum}', color=sfsp.c_unidir, ha='center', rotation=30, fontsize=FSANNO)
plt.text(-0.175/norm, 0.125/norm, '{\\bf Girdle}', color=sfsp.c_planar, ha='center', rotation=-40, fontsize=FSANNO)
