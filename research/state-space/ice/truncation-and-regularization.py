...
(Ezz, Exz, x, y, isvalid) = sfsp.Eij_statemap_ice(grain_params, xlims, ylims, resx=RESX, resy=RESY, ignore_isvalid=True)
...
h_uc20   = plot_trajectory(ax, nlm_uc20,   arrpos=9,    c=sfsp.c_unidir,  ls='--', endmarker=True, mse=mse)
h_ue20   = plot_trajectory(ax, nlm_ue20,   arrpos=17,   c=sfsp.c_planar,  ls='--', endmarker=True, mse=mse)
h_uc6    = plot_trajectory(ax, nlm_uc6,    arrpos=None, c=sfsp.c_unidir,  ls='-',  endmarker=True, mse=mse)
h_ue6    = plot_trajectory(ax, nlm_ue6,    arrpos=None, c=sfsp.c_planar,  ls='-',  endmarker=True, mse=mse)
h_uc6lap = plot_trajectory(ax, nlm_uc6lap, arrpos=None, c=sfsp.cl_unidir, ls=':',  endmarker=True, mse=mse)
h_ue6lap = plot_trajectory(ax, nlm_ue6lap, arrpos=None, c=sfsp.cl_planar, ls=':',  endmarker=True, mse=mse)
...
sfsp.plot_nlm_cases(ax, FSANNO, ms=mse, show_circle=False, isolbl_above=False)
